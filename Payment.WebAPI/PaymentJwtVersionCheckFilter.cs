...
using Payment.WebAPI.Controllers.Response;

namespace Payment.WebAPI
{
	public class PaymentJwtVersionCheckFilter : IAsyncActionFilter
	{
		private readonly IRabbitMqService _rabbitMqService;
		private readonly IDistributedCache _cache;

		public PaymentJwtVersionCheckFilter(IRabbitMqService rabbitMqService, IDistributedCache cache)
        {
